defmodule Talos.Types.StringTypeTest do
  ...
  test "#errors - other params" do
    ...
    assert [value: "String"] == StringType.errors(%StringType{length: 7}, "String")
    assert [] == StringType.errors(%StringType{max_length: 10}, "String")
    assert [value: "String"] == StringType.errors(%StringType{max_length: 3}, "String")
    assert [] == StringType.errors(%StringType{min_length: 3}, "String")
    assert [value: ""] == StringType.errors(%StringType{min_length: 3}, "")
