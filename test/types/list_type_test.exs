defmodule Talos.Types.ListTypeTest do
  ...
  test "#valid? - with additional params" do
    ...
    assert false ==
             ListType.valid?(
               %ListType{type: number_type, allow_nil: true, allow_blank: false},
               []
             )
    ...
    assert true ==
             ListType.valid?(%ListType{type: number_type, allow_blank: true, allow_nil: true}, [])
  ...
  test "#errors - returns errors or empty list" do
    ...
    assert ["list should not be empty"] ==
             ListType.errors(%ListType{type: number_type, allow_blank: false}, [])
